...
export function Logo({ inverse = false }: { inverse?: boolean }) {
  return (
    <Link href="/" className="inline-flex items-center gap-2.5 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" aria-label="FreelanceToolKit home">
      ...
      <span className={`font-display text-[15px] font-bold tracking-tight ${inverse ? "text-white" : "text-ink"}`}>Freelance<span className="text-blue-500">ToolKit</span></span>
