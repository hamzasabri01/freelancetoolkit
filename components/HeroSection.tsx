  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-blue-100 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_58%,#eef6ff_100%)] px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(360px,.78fr)] lg:items-center">
        <div>
          <div className="home-rise mb-5 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-brand shadow-sm backdrop-blur sm:text-[11px]">
            <Sparkles size={13} aria-hidden="true" /> Free freelance pricing calculators
          </div>
          <h1 className="home-rise max-w-4xl font-display text-[2.65rem] font-bold leading-[1.04] tracking-tight text-ink [animation-delay:80ms] sm:text-5xl lg:text-[64px]">
            Price freelance work with clearer numbers, not guesswork
          </h1>
          <p className="home-rise mt-6 max-w-2xl text-base leading-7 text-ink-muted [animation-delay:160ms] sm:text-lg">
          ...
          <div className="home-rise mt-8 flex flex-col gap-3 [animation-delay:240ms] sm:flex-row">
          ...
          <div className="home-rise mt-7 flex flex-wrap gap-x-5 gap-y-2 text-xs font-semibold text-ink-muted [animation-delay:320ms]">
        ...
        <div className="home-rise [animation-delay:.12s]">
          <div className="home-preview-float relative mx-auto max-w-md rounded-[1.75rem] border border-blue-100 bg-white/90 p-4 shadow-[0_24px_70px_rgba(15,23,42,.14)] backdrop-blur">
